...
{
    class CartesianDualLoopAdmittancePDController : public controller_interface::ControllerInterface
    {
    public:
        CartesianDualLoopAdmittancePDController() {}
        ~CartesianDualLoopAdmittancePDController()
        {
            // if (data_logger_)
...
PLUGINLIB_EXPORT_CLASS(controllers::CartesianDualLoopAdmittancePDController, controller_interface::ControllerInterface)