...
namespace controllers
{
    ...
    public:
        ...
        CallbackReturn on_configure(const rclcpp_lifecycle::State & /*previous_state*/) override
        {
            ...
            node_->get_parameter_or<std::vector<double>>("Bx", Bx_vec_, {10.0, 10.0, 10.0, 80.0, 80.0, 80.0});
        ...
        void update(const rclcpp::Time &t, const rclcpp::Duration &period) override
        {
            ...
            ddxc_ = ddxd_ + A_x_inv(Jh_, M_) * (Mu_x_X(Jh_, M_, dJh_, C_, dxe_) + Bx_.asDiagonal() * dxe_ + Kx_.asDiagonal() * xe_) - dJh_ * dq;
            ...
            q_ = q;
            dq_ = dq;
            tau_cmd = saturate_torque(tau_cmd, tau_cmd_);
            tau_cmd_ = tau_cmd;
