...
int main(int argc, char **argv)
{
    ...
    std::vector<double> pose_goal = {0.536320, -0.163060, 0.490, 0.0, 0.0, -0.0}; 
    ...
    std::vector<double> traj_goal = {
        0,  0.536320, -0.163060, 0.490, 0.0, 0.0, -0.0,
        5, 0.536320, -0.163060, 0.468, 0.0, 0.0, -0.0,
        15, 0.536320, -0.163060, 0.468, 0.0, 0.0, -0.0, 
        25, 0.536320, -0.050000, 0.468, 0.0, 0.0, -0.0,  
        35, 0.536320, -0.163060, 0.468, 0.0, 0.0, -0.0,  
    };
