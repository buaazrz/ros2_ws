...
int main(int argc, char **argv)
{
    ...
    // 先用 10 秒平稳移动到组织上方
    10.0,   0.5,      -0.0,   0.31,     3.14159,   0.0,   0.7853,

    // 再缓慢下探
    20.0,   0.5,      -0.0,   0.31,    3.14159,   0.0,   0.7853,

    // 保持
    25.0,   0.5,      -0.0,   0.31,    3.14159,   0.0,   0.7853,

    // 横向运动
    35.0,   0.7,       0.0,   0.31,    3.14159,   0.0,   0.7853,

    45.0,   0.5,      -0.0,   0.31,    3.14159,   0.0,   0.7853,

    // 抬起
    50.0,   0.5,      -0.0,   0.31,     3.14159,   0.0,   0.7853,
};
