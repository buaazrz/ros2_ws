...
static const _VectorData_type_support_symbol_names_t _VectorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_msgs, msg, VectorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_msgs, msg, VectorData)),
  }
};
...
{
  return &::robot_control_msgs::msg::rosidl_typesupport_cpp::VectorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_msgs, msg, VectorData)() {
  return get_message_type_support_handle<robot_control_msgs::msg::VectorData>();
}
