...
#ifndef ROBOT_CONTROL_MSGS__SRV__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
#define ROBOT_CONTROL_MSGS__SRV__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/ControlCommand message.
/**
 ...
 * )) before or use
 * robot_control_msgs__srv__ControlCommand_Request__create()
...
/// Finalize srv/ControlCommand message.
/**
...
/// Create srv/ControlCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_control_msgs__srv__ControlCommand_Request__init().
...
/// Destroy srv/ControlCommand message.
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Request__fini()
...
/// Check for srv/ControlCommand message equality.
/**
...
/// Copy a srv/ControlCommand message.
/**
...
/// Initialize array of srv/ControlCommand messages.
/**
...
/// Finalize array of srv/ControlCommand messages.
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Request__fini()
...
/// Create array of srv/ControlCommand messages.
/**
 * It allocates the memory for the array and calls
 * robot_control_msgs__srv__ControlCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ControlCommand messages.
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ControlCommand message array equality.
/**
...
/// Copy an array of srv/ControlCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * robot_control_msgs__srv__ControlCommand_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_control_msgs__srv__ControlCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_control_msgs__srv__ControlCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * robot_control_msgs__srv__ControlCommand_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_control_msgs__srv__ControlCommand_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_control_msgs__srv__ControlCommand_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_msgs
...
/**
 * It calls
 * robot_control_msgs__srv__ControlCommand_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_CONTROL_MSGS__SRV__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
