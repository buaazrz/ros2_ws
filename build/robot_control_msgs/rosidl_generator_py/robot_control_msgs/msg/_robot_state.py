...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __init__(self, **kwargs):
        ...
        self.robot_state = array.array('d', kwargs.get('robot_state', []))
        ...
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'd', \
                    "The 'robot_state' array.array() must have the type code of 'd'"
            ...
            assert \
                ...
                "The 'robot_state' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._robot_state = array.array('d', value)
