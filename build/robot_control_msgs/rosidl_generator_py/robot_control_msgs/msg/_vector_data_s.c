...
bool robot_control_msgs__msg__vector_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_control_msgs.msg._vector_data.VectorData", full_classname_dest, 46) == 0);
  }
  robot_control_msgs__msg__VectorData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of VectorData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_control_msgs.msg._vector_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VectorData");
