...
class Metaclass_RobotMotion_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('robot_control_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_Goal')
            logger.debug(
...
class RobotMotion_Goal(metaclass=Metaclass_RobotMotion_Goal):
    ...
    _fields_and_field_types = {
        'target_position': 'std_msgs/Float64MultiArray',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float64MultiArray
        self.target_position = kwargs.get('target_position', Float64MultiArray())
    ...
    def target_position(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'target_position' field must be a sub message of type 'Float64MultiArray'"
...
class Metaclass_RobotMotion_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RobotMotion_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMotion_Feedback(metaclass=Metaclass_RobotMotion_Feedback):
    ...
    _fields_and_field_types = {
        'current_position': 'std_msgs/Float64MultiArray',
    }
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                ...
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from std_msgs.msg import Float64MultiArray
        self.current_position = kwargs.get('current_position', Float64MultiArray())
    ...
    def current_position(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Float64MultiArray), \
                "The 'current_position' field must be a sub message of type 'Float64MultiArray'"
...
class Metaclass_RobotMotion_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_control_msgs.action import RobotMotion
...
class RobotMotion_SendGoal_Request(metaclass=Metaclass_RobotMotion_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_control_msgs/RobotMotion_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_control_msgs.action._robot_motion import RobotMotion_Goal
...
class RobotMotion_SendGoal_Event(metaclass=Metaclass_RobotMotion_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robot_control_msgs/RobotMotion_SendGoal_Request, 1>',
        'response': 'sequence<robot_control_msgs/RobotMotion_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_control_msgs.action import RobotMotion_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robot_control_msgs.action import RobotMotion_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_RobotMotion_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_control_msgs.action import _robot_motion
...
class RobotMotion_SendGoal(metaclass=Metaclass_RobotMotion_SendGoal):
    from robot_control_msgs.action._robot_motion import RobotMotion_SendGoal_Request as Request
    from robot_control_msgs.action._robot_motion import RobotMotion_SendGoal_Response as Response
    from robot_control_msgs.action._robot_motion import RobotMotion_SendGoal_Event as Event
...
class RobotMotion_GetResult_Response(metaclass=Metaclass_RobotMotion_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_control_msgs/RobotMotion_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_control_msgs.action._robot_motion import RobotMotion_Result
...
class RobotMotion_GetResult_Event(metaclass=Metaclass_RobotMotion_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<robot_control_msgs/RobotMotion_GetResult_Request, 1>',
        'response': 'sequence<robot_control_msgs/RobotMotion_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_control_msgs.action import RobotMotion_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from robot_control_msgs.action import RobotMotion_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_RobotMotion_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMotion_GetResult(metaclass=Metaclass_RobotMotion_GetResult):
    from robot_control_msgs.action._robot_motion import RobotMotion_GetResult_Request as Request
    from robot_control_msgs.action._robot_motion import RobotMotion_GetResult_Response as Response
    from robot_control_msgs.action._robot_motion import RobotMotion_GetResult_Event as Event
...
class Metaclass_RobotMotion_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMotion_FeedbackMessage(metaclass=Metaclass_RobotMotion_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_control_msgs/RobotMotion_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_control_msgs', 'action'], 'RobotMotion_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_control_msgs.action._robot_motion import RobotMotion_Feedback
...
class Metaclass_RobotMotion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_control_msgs.action.RobotMotion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMotion(metaclass=Metaclass_RobotMotion):
    ...
    from robot_control_msgs.action._robot_motion import RobotMotion_Goal as Goal
    # The result message defined in the action definition.
    from robot_control_msgs.action._robot_motion import RobotMotion_Result as Result
    # The feedback message defined in the action definition.
    from robot_control_msgs.action._robot_motion import RobotMotion_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_control_msgs.action._robot_motion import RobotMotion_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_control_msgs.action._robot_motion import RobotMotion_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_control_msgs.action._robot_motion import RobotMotion_FeedbackMessage as FeedbackMessage
