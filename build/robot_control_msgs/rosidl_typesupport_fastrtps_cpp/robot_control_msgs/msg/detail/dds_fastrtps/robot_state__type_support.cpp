...
#include "robot_control_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_control_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_control_msgs::msg::RobotState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_control_msgs::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_control_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_control_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &robot_control_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_msgs, msg, RobotState)() {
  return &robot_control_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
